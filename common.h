...
#define DELAY_OUTPUT_PWM 10
#define DELAY_OUTPUT_PWM_FAN 2
#define DELAY_READ_SENSOR 20
#define DELAY_MINUTES_TURN_OFF_DEVICE 1
#define DELAY_MINUTES_TURN_OFF_WARMLIGHT 2
#define TIMES_TO_READ_SENSOR 10

#define TURN_ON 1
#define TURN_OFF 0

#define REPORT_DATA_SIZE 6
